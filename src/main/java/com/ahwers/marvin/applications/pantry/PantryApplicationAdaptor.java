...
public class PantryApplicationAdaptor extends ApplicationAdaptor {
	...
	public MarvinResponse getMealPlanForThisWeek(Map<String, String> arguments) {
		...
		response.setResource(new MarvinApplicationResource(getApplicationName(), currentMealPlan.getId(), ResourceRepresentationType.HTML, generateHTMLResourceForMealPlan(currentMealPlan)));
