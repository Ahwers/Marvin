...
public class ApplicationResourcePathRepository {
	...
	private ApplicationResourcePathRepository(ServletContext context) {
		resources.put("graphical_calculator", context.getRealPath("/WEB-INF/classes/resources/graphical_calculator.html"));
		...
		resources.put("command_opening_pleasentries", context.getRealPath("/WEB-INF/classes/resources/command_closing_pleasentries.txt"));
	}
	...
	private ApplicationResourcePathRepository() {
		...
		resources.put("azure_key", getClass().getClassLoader().getResource("./azure_key.txt").getPath().toString());
		...
		resources.put("command_opening_pleasentries", getClass().getClassLoader().getResource("./resources/command_closing_pleasentries.txt").getPath().toString());
	}
